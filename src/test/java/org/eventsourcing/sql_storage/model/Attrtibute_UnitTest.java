...
public class Attrtibute_UnitTest {
    ...
    public void builder_reference_no_relation() {
        ...
        // Verify
        assertTrue(thrown.getMessage().contains("has no relation defined"));
    }
    ...
    public void builder_non_reference_has_relations() {
        ...
        // Verify
        assertTrue(thrown.getMessage().contains("is not allowed to have relations"));
    ...
    public void builder_duplicate_relation_target() {
        ...
        // Verify
        assertTrue(thrown.getMessage().contains("has duplicate target entities"));
    }
